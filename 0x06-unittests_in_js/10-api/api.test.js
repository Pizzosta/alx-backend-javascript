...
describe('API Integration test', () => {
  ...
  it('GET /cart/:id should return 404 response for a neg no. :id', (done) => {
  ...
  it('GET /cart/:id return 404 res for an non-numeric value of :id', (done) => {
  ...
  it('POST /login should return a valid response', (done) => {
    request.post(`${URL}/login`, {json: {userName: 'Betty'}},
        (_, res, body) => {
          expect(res.statusCode).to.be.equal(200);
